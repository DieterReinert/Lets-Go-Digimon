...
// Digimon X Pokemon
const LETS_GO = require('../letsgo/random-teams');
const RandomLetsGoTeams = new LETS_GO('digimondigimonxpokemon');
	...
	randomDigimonTeam() {
		...
		let sets = {
			...
			"ClearAgumon": {
				species: "ClearAgumon",
				ability: "Vaccine",
				moves: ['heatbreath', 'holyterrain', 'saintray', 'holyflash', 'mechanicalclaw', 'upgrade', 'gigawattlaser'],
			...
			"Guardromon": {
				species: "Guardromon",
				ability: "Vaccine",
				moves: ['upgrade', 'reverseprogram', 'antiattackfield', 'gigawattlaser', 'megalospark', 'holyterrain', 'firetower', 'firewall', 'thunderjustice'],
			...
			"Leomon": {
				species: "Leomon",
				ability: "Vaccine",
				moves: ['musclecharge', 'warcry', 'sonicjab', 'meltdown', 'infinityburn', 'megatonpunch', 'earthcoat', 'holyterrain', 'burningheart'],
			...
			"IceLeomon": {
				species: "IceLeomon",
				ability: "Data",
				moves: ['musclecharge', 'warcry', 'gigafreeze', 'icestatue', 'megatonpunch', 'winterblast', 'aurorafreeze', 'holyterrain', 'burningheart'],
			...
			"MagnaAngemon": {
				...
				ability: "Vaccine",
				moves: ['saintheal', 'holyterrain', 'shiningnova', 'thunderjustice', 'antiattackfield', 'gigawattlaser', 'deleteprogram', 'sonicjab', 'megalospark', 'reboundstrike', 'holyjudgment', 'wingshoes'],
			...
			"Monzaemon": {
				species: "Monzaemon",
				ability: "Vaccine",
				moves: ['fightingaura', 'poopattackfield', 'reboundstrike', 'megatonpunch', 'saintheal', 'holybreath', 'holyterrain', 'saintray', 'charmperfume'],
			...
			"Piximon": {
				species: "Piximon",
				ability: "Data",
				moves: ['saintheal', 'holybreath', 'holyterrain', 'fightingaura', 'shiningnova', 'wingshoes', 'windcutter', 'electriccloud', 'antiattackfield', 'earthcoat', 'bug'],
			...
			"Whamon": {
				species: "Whamon",
				ability: "Vaccine",
				moves: ['waterblitz', 'oceanwave', 'icestatue', 'aurorafreeze', 'massmorph', 'charmperfume', 'holyterrain', 'confusedstorm', 'busterdrive', 'saintheal'],
			...
			"Alphamon": {
				species: "Alphamon",
				ability: "Vaccine",
				moves: ['holyterrain', 'saintray', 'holyjudgment', 'shiningnova', 'warcry', 'sonicjab', 'reboundstrike', 'upgrade', 'deleteprogram', 'dgdimension', 'burningheart', 'thunderjustice'],
			...
			"HerculesKabuterimon": {
				...
				ability: "Data",
				moves: ['confusedstorm', 'electriccloud', 'megalospark', 'thunderjustice', 'charmperfume', 'massmorph', 'bug', 'holyterrain', 'holyflash', 'fightingaura'],
			...
			"MarineAngemon": {
				...
				ability: "Vaccine",
				moves: ['waterblitz', 'oceanwave', 'aurorafreeze', 'icestatue', 'saintheal', 'holybreath', 'holyterrain', 'shiningnova', 'confusedstorm', 'wingshoes', 'antiattackfield', 'earthcoat'],
			...
			"Ophanimon": {
				species: "Ophanimon",
				ability: "Vaccine",
				moves: ['wingshoes', 'windcutter', 'thunderjustice', 'fightingaura', 'aurorafreeze', 'saintheal', 'holybreath', 'holyterrain', 'saintray', 'warcry'],
			...
			"SaberLeomon": {
				species: "SaberLeomon",
				ability: "Data",
				moves: ['musclecharge', 'warcry', 'fightingaura', 'busterdrive', 'earthcoat', 'venomdisaster', 'holyterrain', 'holyjudgment', 'mechanicalclaw', 'burningheart', 'infinityburn', 'shiningnova'],
		...
		// Digimon Monotype
		let isMonotype = this.format.id === 'digimondigimonshowdownmonotype' || this.format.id === 'digimondigimonshowdownmonotypedoubles';

		// Generate the team randomly.
		let pool = !isMonotype ? Object.keys(sets) : [];
		let weakmonclause = false;

		// Monotype
		if (isMonotype) {
			let typePool = ['Flame', 'Aqua', 'Air', 'Nature', 'Holy', 'Evil', 'Battle', 'Mech', 'Filth'];
			// this.sample is asynchronous
			let type = typePool[~~(Math.random() * typePool.length)];
		...
		// Digimon X Pokemon
		let isDxP = this.format.id === 'digimondigimonxpokemon' || this.format.id === 'digimondigimonxpokemondoubles';
		if (isDxP) {
			let randPokeTeam = RandomLetsGoTeams.randomTeam();
			for (let i = 0; i < 3; i++) {
				team.push(this.sampleNoReplace(randPokeTeam));
			}
		}


		for (let i = 0; i < (isDxP ? 3 : 6); i++) {
