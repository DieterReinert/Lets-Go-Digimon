...
//This Code is Retired and Not Recommended to use without applying fixes to moves.ts. Anti-Sleep, Anti-Poison and Anti-Paralysis only partially work as intended. Anti-Panic and Dispel are broken, Anti-Bug is likely broken but untested. Also, these moves were retired to use more accurate and approachable pokemon moves instead.//
